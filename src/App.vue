    ...
    <el-container v-else>
      <el-header class="header">
        ...
        <el-dropdown @command="handleCommand">
          ...
          {{ currentUser && (currentUser.nickname || currentUser.username) }}<i class="el-icon-arrow-down el-icon--right"></i>
        </span>
      ...
      <el-container>
        ...
        <el-main>
          <router-view class="page" ref="page" v-loading.lock="isLoadingShown"></router-view>
        </el-main>
      </el-container>
    </el-container>
  </div>
...
export default {
  ...
  computed: {
    ...
    ...mapState(['currentUser', 'isLoadingShown'])
  },
  components: {
    Menu
  },
  created() {
    this.defineApiHandler()
  },
  methods: {
    defineApiHandler() {
