  ...
  <div class="user-sign-in-page">
    <div class="sign-in-panel">
      <div class="company-info">
        ...
        <p class="text-muted">Git: git@github.com:avicha/admin_frontend_template.git</p>
        <p class="text-muted">E-mail: avichabc@gmail.com</p>
        <p class="text-muted">Website: <a href="https://github.com/avicha">https://github.com/avicha</a></p>
      </div>
